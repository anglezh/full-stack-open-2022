  ...
  describe('Login', () => {
    ...
    describe('When logged in', function () {
      ...
      it('A blog can be created', function () {
        ...
        cy.get('#blog-url').type('https://docs.cypress.io/guides/core-concepts/introduction-to-cypress#Cypress-Can-Be-Simple-Sometimes')
      ...
      describe('when blog created', function () {
        beforeEach(function () {
          cy.createBlog({ title: 'cypress简介', author: 'un', url: 'www.eee.com' })
          cy.createBlog({ title: 'cypress简介1', author: 'un1', url: 'www.eee.com' })
          cy.createBlog({ title: 'cypress简介2', author: 'un2', url: 'www.eee.com' })
        })
        it('like can be click', function () {
          ...
          cy.contains('cypress简介1 un1').parent().find('button').filter('.like-toggle').click()
          // cy.contains('like').click()
        })
        it('blog can deleted', function () {
          cy.contains('cypress简介 un').contains('view').click()
          cy.contains('cypress简介 un').parent().find('button').filter('.remove-blog').click()
        })
      })
      describe('when blog created and likes', function () {
        beforeEach(function () {
          cy.createBlog({ title: 'cypress简介', author: 'un', url: 'www.eee.com', likes: 5 })
          cy.createBlog({ title: 'cypress简介1', author: 'un1', url: 'www.eee.com', likes: 4 })
          cy.createBlog({ title: 'cypress简介2', author: 'un2', url: 'www.eee.com', likes: 3 })
        })
